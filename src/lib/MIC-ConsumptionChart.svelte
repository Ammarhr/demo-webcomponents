...
<script>
  ...
  import { fetchDailyUsageChart, fetchMonthlyUsageChart } from "../js/store";
  import { chart } from "../js/svelte-apexcharts";
  import { renderMixChart, onPeakOffPeakChart } from "../js/chart-options";
  ...
  export let meterobj =
    '{"DLN":"9000096243","AMI_Flag":"X","Contract":"X","HistoricalFact":"HIST_KWH","ZipCode":"33615","DAP_StartDate":"20230201","DAP_EndDate":"20230301","intp":"","DAP_dkwh":"x","DAP_rkwh":"","DAP_pf":"","DAP_kw":"","UOF":"KWH","DAP_dtoun":"","DAP_dtouf":"","Operand":"ss","StandbyCustomer_Flag":"X","Service":"ELECTRIC"}';
  ...
  onMount(() => {
    ...
    if (selectedmeter) {
      ...
      if (AMI_Flag == "X") {
        dailyUsageGet(refreshabletoken, dailyurl);
      }
      ...
      monthlyUsageGet(refreshabletoken, monthlyurl).then(() => {});
